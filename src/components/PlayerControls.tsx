    ...
    >
      ...
      <div className="flex items-center gap-3 justify-center">
        ...
        <input
          ...
          className="w-24 h-1 appearance-none bg-white/40 rounded-full outline-none transition-all [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:bg-linear-to-br [&::-webkit-slider-thumb]:from-[#f9b69d] [&::-webkit-slider-thumb]:to-[#ff9999] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:hover:scale-110 [&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3 [&::-moz-range-thumb]:bg-linear-to-br [&::-moz-range-thumb]:from-[#f9b69d] [&::-moz-range-thumb]:to-[#ff9999] [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:shadow-lg"
        />
      </div>
